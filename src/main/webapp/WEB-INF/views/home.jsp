...
<html>
    ...
    <div align = "center">
        ...
        <div align = "center"><a href="${pageContext.request.contextPath}/adminpanel"> Admin Panel</a></div>
       <div align = "center">  
      ...
      <table cellspacing="0" cellpadding="10" width="100%">
      	...
      	<table cellspacing="0" cellpadding="0" bgcolor="red">
      		...
      		<tr>
      		<td colspan="2" class="menutd"><a class="menu" href="/">Home</a> <a class="menu" href="${pageContext.request.contextPath}/login">Login</a>   <a class="menu" href="register">Sign Up</a>
