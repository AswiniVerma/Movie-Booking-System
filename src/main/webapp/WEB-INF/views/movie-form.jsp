...
<tr>
<td>Title :</td><td><form:input path="title" required = "required" pattern="[A-Za-z0-9]*"/>
...
<tr>
<td>Release Date :</td><td><form:input path="releaseDate" required = "required" />
<form:errors path="releaseDate" cssClass="error"/>
</td>
</tr>

<tr>
<td>Duration :</td><td><form:input path="movieLength" required = "required" />
<form:errors path="movieLength" cssClass="error"/>
</td>
</tr>

<tr>
<td>Genre :</td><td><form:input path="movieGenre"  required = "required"/>
...
<tr>
<td>Language :</td><td><form:select path="movieLanguage" required = "required">  
...
<tr>
<td>Description :</td><td><form:input path="movieDescription"  required = "required"/>
...
<tr>
<td>Director :</td><td><form:input path="movieDirector" required = "required" />
<form:errors path="movieDirector" cssClass="error"/>
</td>
</tr>

<tr>
<td>Cast :</td><td><form:input path="movieHero" required = "required"/>
...
<td>
Select photo:
<input type="file" name="photo" required = "required"/></td>
